...
1. Create new project in Godot or use existing project.
...
7. You'll see panel Godobuf in Gotot.<br/>
![Plugins](/readme-images/3.png)

## Usage

1. Open file dialog window `Input protobuf file`.
2. Choose *.proto file in dialog window.<br/>
...
9. If compilation was successful new GDScript will be created in the specified directory.
...
from_bytes() method returns success or error state.<br/>
...
### 2. String
Use is similar as scalar types.
#### Set value
...
### 4. Enum
Use is similar as scalar types, but values should be taken from Enum which was generated by compiler.<br/>
...
### 5. Oneof
Use is similar as scalar types, but you can set the value for only one field grouped in oneof.<br/>
